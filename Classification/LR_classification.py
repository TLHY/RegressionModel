...
#class weight was added to LogisticRegression function because the data gets very one-sided after split
model = LogisticRegression(class_weight = 'balanced',multi_class='ovr').fit(X_train, y_train) 
y_predict=model.predict(X_test)
acc,prec,rec,f1=classification_performance_eval(y_test,y_predict)
print("==============================")
print("LogisticRegression train_test_split result")
print("==============================")
...
print("==============================")
print("LogisticRegression KFold result")
print("==============================")
